...
import com.wuzekai.dao.MenuInfoMapper;
...
public class MenuInfoServiceImpl implements MenuInfoService {
    ...
    public boolean updateRoleMenu(ModifyRoleMenuDTO modifyRoleMenuDTO) {
        boolean  flag = false;
        //将数据库中存在但modifyRoleMenuDTO.menuIds中不存在的数据删除
        int count1 = menuInfoMapper.removeRoleMenuByMenuId(modifyRoleMenuDTO);
        //从数据库中查询出所有经过删除以后roleid为modifyRoleMenuDTO.roleId的数据信息
